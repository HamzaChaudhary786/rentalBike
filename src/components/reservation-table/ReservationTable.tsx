                            ...
                            <>
                                ...
                                <div>
                                    ...
                                    <section className='flex gap-x-8'>
                                        <h1>Bike Color : <span className='text-[red] text-2xl'>{item.bikeColor}</span></h1>
                                        <h1>Model: <span className='text-[red] text-2xl'>{item.bikeModal}</span></h1>
                                    </section>
                                    <table className="min-w-full divide-y divide-gray-200 border border-gray-200">
                                        <thead className="bg-gray-50">
                                            <tr>
                                                ...
                                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border border-gray-200">Types</th>
